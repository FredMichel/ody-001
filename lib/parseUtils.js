...
var parseUtils = {
    ...
    getStatusCountSummary: function (jsonObj, plugin) {
        ...
        if (plugin == 'hpsc') {
            ...
            if (!jsonObj.hasOwnProperty('insertResponse')) {
                return {
                    countIgnored: 'N/A',
                    countInsert: 'N/A',
                    countUpdate: 'N/A',
     ...
     *
     **/
    getResponseXML: function (jsonObj, plugin) {
        var scope, number, status, message, xml_body;
        ...
        if (plugin == 'hpsc') {
            ...
            if (jsonObj.status == 'error') {
                ...
                message = jsonObj.status_message;
            }
